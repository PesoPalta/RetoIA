...
def main():
    ...
    instances_file = "Queries\\NY-queries-3p.txt"
    output_file = "Resultados\\resultados-query3.txt"
    ...
    print("Proceso completado. Los resultados se guardaron en 'resultados-query3.txt'.")
