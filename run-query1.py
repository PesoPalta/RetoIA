...
def main():
    ...
    instances_file = "Queries\\NY-queries-1p.txt"
    output_file = "Resultados\\resultados-query1.txt"
    ...
    print("Proceso completado. Los resultados se guardaron en 'resultados-query1.txt'.")
